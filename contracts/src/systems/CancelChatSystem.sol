...
uint256 constant ID = uint256(keccak256("system.CancelChat"));

// struct CancelChatDetail {
//     uint256 entityId;
//     string detail;
// }

contract CancelChatSystem is System {
  ...
  function executeTyped(uint256 target) public returns (bytes memory) {
